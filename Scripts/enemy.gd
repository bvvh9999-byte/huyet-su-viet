...
# ==========================================
# CHỊU ĐÒN VÀ TỬ VONG (XÓA SẠCH LỖI "DIE")
# ==========================================
func take_damage(damage_amount):
	...
	if hp <= 0:
		...
		# Dừng ngay hành động hiện tại để làm cái xác
		...
		# Hiệu ứng cái xác mờ dần rồi biến mất (Tránh lỗi văng game)
